  ...
  <div class="content-wrapper">
    ...
    <div class="card">
      ...
      <div style="margin-top: 20px;">
        <a href="../assets/REGULAMENTO PARA SUBMISSÃO, AVALIAÇÃO E APRESENTAÇÃO DE TRABALHOS CIENTÍFICOS - EM CONSTRUÇÃO.pdf" target="_blank" class="btn-download">
      ...
      <div class="footer-col footer-right">
        ...
        <div class="social">
          <a href="https://www.instagram.com/ecac.alimentacaocoletiva/" target="_blank">
            <img src="../assets/img/INSTAGRAM NOVO  SEM FUNDO.png" alt="Link do Instagram" class="img-rodape">
          </a>
          <a href="#" onclick="abrirEmail(event)">
            <img src="../assets/img/EMAIL NOVO SEM FUNDO.png" alt="Link do E-mail" class="img-rodape">
          </a>
          </a>
          <a href="#" onclick="abrirWhatsApp(event)">
            <img src="../assets/img/ZAP NOVVO  SEM FUNDO.png" alt="Link do WhatsApp" class="img-rodape">
          </a>
        </div>
        <p>(21) 99214-1882</p>
      </div>
