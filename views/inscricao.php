    ...
    <div class="page-content">
      ...
      <div class="content-wrapper">
        ...
        <section class="normas" aria-labelledby="normasTitle">
          ...
          <!-- CTA para Even3 -->
          <div class="cta-area">
            <a class="cta-button" href="https://www.even3.com.br/evento/login?evento=encontro-carioca-de-alimentacao-coletiva-2026-721287&lang=pt" target="_blank" rel="noopener noreferrer">INSCREVA-SE
              NO EVENTO</a>
          </div>
        </section>
      </div>
