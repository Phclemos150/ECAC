document.addEventListener("DOMContentLoaded", () => {
  ...
  if (form) {
    ...
    form.addEventListener("submit", (e) => {
      ...
      // SE TIVER ALGO ERRADO: Deixa o formulário ir para o PHP gravar o Log e devolver o erro
      if (!formValido) {
        // Apenas pinta de vermelho, mas NÃO bloqueia o envio (removido o e.preventDefault)
        // O PHP vai receber os dados vazios, gravar no log e devolver a tela com a mensagem de erro.
      }
    });
  }
});
